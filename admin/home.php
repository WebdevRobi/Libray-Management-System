    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="adduser.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <button class="btn btn-primary hidden-print" onclick="print()">Print Report</button>
                <br>
