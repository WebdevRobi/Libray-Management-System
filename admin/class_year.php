...
<div class="wrapper">
  ...
  <?php include 'includes/classyear_modal.php'; ?>
</div>
...
<noscript id="print-header">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <h3 class="text-center"><b>Class Year List</b></h3>
        </div>
        <div class="col-2"></div>
    </div>
...
$('#print').click(function(){
  ...
  _el.append(_h)
  _el.append(_ph)
  _el.find('title').text('Class year List - Print View')
  _el.append(_p)
