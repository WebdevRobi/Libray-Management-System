...
<div class="modal fade" id="addnew">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group">
                    <label for="quantity_add" class="col-sm-3 control-label">Quantity Stocks</label>

                    <div class="col-sm-9">
                      <div class="number">
                        <input type="text" class="form-control" id="quantity_add" name="quantity">
                      </div>
                    </div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="quantity_edit" class="col-sm-3 control-label">Quantity Stocks</label>

                    <div class="col-sm-9">
                      <div class="number">
                        <input type="text" class="form-control" id="quantity_edit" name="quantity">
                      </div>
                    </div>
                </div>
          	</div>
