        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="student_add.php">
				...
				<div class="form-group">
                    <label for="gender" class="col-sm-3 control-label">Student Gender</label>
                ...
                <div class="form-group">
                    <label for="course" class="col-sm-3 control-label">Section</label>
                ...
                <div class="form-group">
                    <label for="course" class="col-sm-3 control-label">Class Year</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="class_year" name="class_year" required>
                        <option value="" selected id="selcourse"></option>
                        <?php
                          $sql = "SELECT * FROM class_year";
                          $query = $conn->query($sql);
                          while($row = $query->fetch_array()){
                            echo "
                              <option value='".$row['id']."'>".$row['class_year']."</option>
                            ";
                          }
                        ?>
                      </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="edit_course" name="course" required>
                        <option value="" selected id="edit_course"></option>
                        <?php
                          $sql = "SELECT * FROM course";
                          $query = $conn->query($sql);
                          while($row = $query->fetch_array()){
